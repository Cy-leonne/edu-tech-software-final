...
import { getGuestDemoFields, GUEST_DEMO_UNAVAILABLE_MESSAGE } from '../utils/guestDemo';
...
const LoginPage = ({ role }) => {
    ...
    const guestModeHandler = () => {
        // SECURITY: no demo credentials are hard-coded in the bundle; they are
        // read from REACT_APP_GUEST_* variables and only used when demo mode is
        // explicitly enabled (see src/utils/guestDemo.js).
        const fields = getGuestDemoFields(role);
    ...
    return (
        <ThemeProvider theme={defaultTheme}>
            <Grid container component="main" justifyContent="center" sx={{ minHeight: '100vh' }}>
                <CssBaseline />
                ...
                <Grid
                    ...
                    md={7}
                    sx={{
                        display: { xs: 'none', sm: role === 'Student' ? 'none' : 'block' },
